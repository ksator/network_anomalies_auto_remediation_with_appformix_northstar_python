...
[**Events driven automation in this repository**](README.MD#events-driven-automation-in-this-repository)  
...
This repository has scripts to quickly demo network devices monitoring using Appformix. It has also scripts to demo events driven automation using Appformix: 
...
- The actions triggered are python scripts to:   
      - collect automatically data on the "faulty" device and upload them on a Git server  
...
## Events driven automation in this repository 
...
On the local repository (local copy of the remote repository):  
```
# ls vmx104/
