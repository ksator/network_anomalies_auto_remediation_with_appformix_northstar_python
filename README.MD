...
- [configure the network devices with the SNMP community used by Appformix to monitor network devices](
...
- [listen and react to webhooks sent by Appformix](README.MD#webhooks)  
