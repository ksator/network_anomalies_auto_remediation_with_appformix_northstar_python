...
[**Building blocks**](README.MD#building_blocks)  
...
So this repo has content to run demos, to demonstrate a concept.    
...
This repository uses the following building blocks: 
- Juniper vMX devices. 
  - But other Junos devices can be used. 
