...
```
If Appformix has serveral ip addresses, and you want to configure the network devices to use another IP address for telemetry server, execute this script:
