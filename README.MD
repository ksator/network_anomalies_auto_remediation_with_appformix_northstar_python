[![Build Status](https://travis-ci.org/ksator/network_anomalies_auto_remediation_with_appformix_northstar_python.svg?branch=master)](https://travis-ci.org/ksator/network_anomalies_auto_remediation_with_appformix_northstar_python)  
...
```
sudo -s
git clone https://github.com/ksator/network_anomalies_auto_remediation_with_appformix_northstar_python.git
```
...
```
sudo -s
cd network_anomalies_auto_remediation_with_appformix_northstar_python
...
## Unplanned maintenance operations demo
